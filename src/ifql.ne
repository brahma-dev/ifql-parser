...
table ->
  ...
  | identifier "." identifier "." identifier {% d => ({type: 'table', value: d[0].value +'.'+ d[2].value+'.'+ d[4].value, database: d[0].value, retention: d[2].value, table: d[4].value }) %}
  | identifier "." identifier {% d => ({type: 'table', table: d[0].value +'.'+ d[2].value, database: d[0].value, table: d[2].value }) %}
