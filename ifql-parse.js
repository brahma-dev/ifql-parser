...
var grammar = {
    ...
    {"name": "table", "symbols": ["identifier", {"literal":"."}, "identifier", {"literal":"."}, "identifier"], "postprocess": d => ({type: 'table', value: d[0].value +'.'+ d[2].value+'.'+ d[4].value, database: d[0].value, retention: d[2].value, table: d[4].value })},
    {"name": "table", "symbols": ["identifier", {"literal":"."}, "identifier"], "postprocess": d => ({type: 'table', table: d[0].value +'.'+ d[2].value, database: d[0].value, table: d[2].value })},
    ...
    {"name": "where_clause", "symbols": ["WHERE", "identifier", "bit_expr", "identifier"], "postprocess": d => ({type:'where', condition: d[2] })},
    ...
    {"name": "literal", "symbols": ["decimal", "time_range"], "postprocess": d => ({type: 'decimal', value: d[0], range: d[1]})},
    {"name": "literal", "symbols": ["decimal"], "postprocess": d => ({type: 'decimal', value: d[0]})},
    ...
    {"name": "time_range", "symbols": ["D"], "postprocess": d => dataType('day')},
    {"name": "time_range", "symbols": ["H"], "postprocess": d => dataType('hour')},
    {"name": "time_range", "symbols": ["M"], "postprocess": d => dataType('minute')},
    {"name": "time_range", "symbols": ["S"], "postprocess": d => dataType('second')},
    {"name": "time_range", "symbols": ["M", "S"], "postprocess": d => dataType('millisecond')},
    {"name": "time_range", "symbols": ["U"], "postprocess": d => dataType('microsecond')},
    {"name": "time_range", "symbols": ["N", "S"], "postprocess": d => dataType('nanosecond')},
